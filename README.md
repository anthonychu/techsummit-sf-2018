...
[**Register Now**](https://www.microsoftevents.com/profile/form/index.cfm?PKformID=0x3480060abcd?WT.mc_id=techsummit-links-antchu)
...
* [.NET Standard ZIP demo](https://github.com/anthonychu/netstandard-zip-demo)
* [ASP.NET Core Benchmarks](https://github.com/aspnet/benchmarks)
* [Learn .NET Core](https://www.microsoft.com/net/learn/get-started/?WT.mc_id=techsummit-links-antchu)
* [Download Visual Studio](https://www.visualstudio.com/?WT.mc_id=techsummit-links-antchu)
* [Azure Container Service (AKS) - Managed Kubernetes](https://docs.microsoft.com/azure/aks/)
* [Azure Container Instances](https://docs.microsoft.com/azure/container-instances/?WT.mc_id=techsummit-links-antchu)
...
* [Azure Functions Documentation](https://docs.microsoft.com/azure/azure-functions/?WT.mc_id=techsummit-links-antchu)
* [Azure Functions on GitHub](https://github.com/Azure/Azure-Functions)
* [Function Library](https://functionlibrary.azurewebsites.net/)
* [Azure Functions Recipes](https://docs.microsoft.com/sandbox/functions-recipes/?WT.mc_id=techsummit-links-antchu)
